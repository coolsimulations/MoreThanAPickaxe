...
public class MoreThanAPickaxeUpdateHandler {
	...
	public static void init() {
		...
		try {
            URL url = new URL("https://coolsimulations.net/mcmods/morethanapickaxe-fabric/versionchecker114.txt");
		...
		try {
            URL url = new URL("https://coolsimulations.net/mcmods/morethanapickaxe-fabric/updateinfo114.txt");
            Scanner s = new Scanner(url.openStream());
