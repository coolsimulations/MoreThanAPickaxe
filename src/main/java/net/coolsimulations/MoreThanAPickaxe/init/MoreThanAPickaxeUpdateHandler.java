...
public class MoreThanAPickaxeUpdateHandler {
	...
	public static void init() {
		...
		try {
            URL url = new URL("https://coolsimulations.net/mcmods/morethanapickaxe/versionchecker118.txt");
		...
		try {
            URL url = new URL("https://coolsimulations.net/mcmods/morethanapickaxe/updateinfo118.txt");
            Scanner s = new Scanner(url.openStream());
