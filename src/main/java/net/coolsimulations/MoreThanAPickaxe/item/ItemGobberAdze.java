...
public class ItemGobberAdze extends ItemAdze {
	...
	public ItemGobberAdze(Tier material, float damage, float speed, FabricItemSettings builder) {
		this(material, damage, speed, builder, false);
	}
	
	public ItemGobberAdze(Tier material, float damage, float speed, FabricItemSettings builder, boolean unbreakable) {
		super(material, damage, speed, builder, true, unbreakable);
		SPGobberEnchantments.faster_obsidian.add(this);
	}
	...
	public float getDestroySpeed(ItemStack stack, BlockState state)
	{
		...
		else if(AXE_BLOCKS.contains(material) || material == Material.METAL || material == Material.HEAVY_METAL || material == Material.STONE)
		{
			return this.speed;
		}
	...
	static
	{
		AXE_BLOCKS = Sets.newHashSet(Material.WOOD, Material.NETHER_WOOD,
				...
				Material.BAMBOO, Material.VEGETABLE);
	}
